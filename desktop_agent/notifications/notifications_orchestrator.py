...
class NotificationsOrchestrator:
        ...
        try:
            ...
            if action == "create_notification" and self._notification_manager:
                ...
                if alert_id and name:
                    from alert_system import AlertSeverity, AlertCondition
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "component_statuses": {
                "notification_manager": self._notification_manager.get_status() if self._notification_manager else None,
                "alert_system": self._alert_system.get_status() if self._alert_system else None,
                "notification_router": self._notification_router.get_status() if self._notification_router else None,
            },
        }
