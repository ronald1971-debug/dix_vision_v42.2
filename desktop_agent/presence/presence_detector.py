...
class PresenceDetector:
    ...
    async def initialize(self, config: Optional[Dict[str, Any]] = None) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Presence Detector configured: idle_timeout={self._config['idle_timeout']}")
    ...
    async def detect_presence(self, activity_data: Optional[Dict[str, Any]] = None) -> PresenceState:
