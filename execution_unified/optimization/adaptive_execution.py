...
class StrategySelector:
    ...
    def __init__(self):
        ...
        logger.info("[STRATEGY_SELECTOR] Initialized with {len(self._available_strategies)} strategies")
    ...
    def _score_strategy(self, strategy: ExecutionStrategy, conditions: ConditionAnalysis) -> tuple[float, str]:
        ...
        if conditions.time_constraint == "STRICT":
            ...
            if strategy.strategy_type in [StrategyType.COST_OPTIMIZED, StrategyType.THROUGHPUT_OPTIMIZED]:
                score += 15
...
class StrategyOptimizer:
    ...
    def optimize(
        ...
        with self._lock:
            ...
            perf.average_latency_ms = performance_feedback.get("latency_ms", perf.average_latency_ms)
            perf.average_throughput = performance_feedback.get("throughput", perf.average_throughput)
