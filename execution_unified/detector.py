...
from system_unified_unified_unified_unified.config import get as get_config
from system_unified_unified_unified_unified.health_monitor import get_health_monitor
...
class HazardDetector:
    ...
    def _check_system_health(self) -> None:
        ...
        for component, healthy in status.items():
            if not healthy:
                self._emitter.system_degradation(f"component={component} status=DEGRADED")
