...
new_services = {
    ...
    "scipy-optimize-service": {
        "build": {
            "context": "./containers/github_repos/scipy-optimize",
    ...
    "montecarlo-python-service": {
        "build": {
            "context": "./containers/github_repos/montecarlo-python",
            "dockerfile": "Dockerfile",
        },
    ...
    "kubernetes-python-service": {
        "build": {
            "context": "./containers/github_repos/kubernetes-python",
            "dockerfile": "Dockerfile",
        },
    ...
    "beautifulsoup4-service": {
        "build": {
            "context": "./containers/github_repos/beautifulsoup4",
            "dockerfile": "Dockerfile",
        },
    ...
    "socket.io-client-service": {
        "build": {
            "context": "./containers/github_repos/socket.io-client",
            "dockerfile": "Dockerfile",
        },
    ...
    "pydantic-settings-service": {
        "build": {
            "context": "./containers/github_repos/pydantic-settings",
            "dockerfile": "Dockerfile",
        },
    ...
    "redis-py-cluster-service": {
        "build": {
            "context": "./containers/github_repos/redis-py-cluster",
            "dockerfile": "Dockerfile",
        },
