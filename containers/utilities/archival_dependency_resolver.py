...
class ArchivalDependencyResolver:
    ...
    def resolve_archival_imports(self, file_path: str) -> int:
        ...
        is_execution = (
            "execution_archived" in file_path
            or "engine_archive" in file_path
            or "adapters_archive" in file_path
            or "hazard_archive" in file_path
            or "live_trading_archive" in file_path
            or "monitoring_archive" in file_path
            or "confirmations_archive" in file_path
            or "algos_archive" in file_path
            or file_path.endswith("_archive.py")
        )
