...
def create_consent_request(
    consent_id: str, kind: ConsentKind, description: str, parameters: Dict[str, Any] = None
) -> ConsentRequest:
    """Create a new consent request"""
    return ConsentRequest(
        consent_id=consent_id, kind=kind, description=description, parameters=parameters or {}
    )
