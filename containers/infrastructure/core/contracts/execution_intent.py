...
class ExecutionIntent:
    ...
    def is_executable(self) -> bool:
        ...
        return self.status in [IntentStatus.PENDING, IntentStatus.APPROVED] and (self.expiry == 0.0 or self.expiry > time.time())
...
class IntentRegistry:
    ...
    def _update_status(self, intent_id: str, new_status: IntentStatus, old_status: IntentStatus) -> None:
...
def create_intent(intent_id: str, intent_type: IntentType, priority: IntentPriority, requester: str) -> ExecutionIntent:
...
def create_execution_intent(intent_id: str, intent_type: IntentType, priority: IntentPriority, requester: str, parameters: Dict[str, Any] = None) -> ExecutionIntent:
