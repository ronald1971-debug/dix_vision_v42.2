...
LEGAL_PATCH_TRANSITIONS = {
    ...
    PatchStage.ANALYZED: [PatchStage.VALIDATED, PatchStage.REJECTED, PatchStage.CANCELLED, PatchStage.STATIC_ANALYSIS],
    PatchStage.STATIC_ANALYSIS: [PatchStage.VALIDATED, PatchStage.DYNAMIC_ANALYSIS, PatchStage.REJECTED, PatchStage.CANCELLED, PatchStage.BACKTEST],
    PatchStage.DYNAMIC_ANALYSIS: [PatchStage.VALIDATED, PatchStage.SANDBOX, PatchStage.REJECTED, PatchStage.CANCELLED],
    PatchStage.BACKTEST: [PatchStage.VALIDATED, PatchStage.SHADOW, PatchStage.REJECTED, PatchStage.CANCELLED],
    PatchStage.SHADOW: [PatchStage.APPROVED, PatchStage.REJECTED, PatchStage.CANCELLED, PatchStage.CANARY],
    PatchStage.CANARY: [PatchStage.APPROVED, PatchStage.REJECTED, PatchStage.CANCELLED, PatchStage.PRODUCTION],
    PatchStage.PRODUCTION: [PatchStage.COMPLETED, PatchStage.FAILED, PatchStage.ROLLED_BACK, PatchStage.REJECTED],
    PatchStage.VALIDATED: [PatchStage.APPROVED, PatchStage.REJECTED, PatchStage.CANCELLED, PatchStage.SANDBOX],
    PatchStage.APPROVED: [PatchStage.PLANNED, PatchStage.CANCELLED, PatchStage.REJECTED],
    PatchStage.PLANNED: [PatchStage.IN_PROGRESS, PatchStage.CANCELLED, PatchStage.REJECTED, PatchStage.SANDBOX],
    PatchStage.SANDBOX: [PatchStage.APPROVED, PatchStage.REJECTED, PatchStage.CANCELLED],
    PatchStage.IN_PROGRESS: [PatchStage.COMPLETED, PatchStage.FAILED, PatchStage.ROLLED_BACK, PatchStage.REJECTED],
...
class PatchPipelineError(Exception):
    ...
    def __init__(self, message: str, patch_id: str, current_stage: PatchStage, attempted_stage: PatchStage):
        self.patch_id = patch_id
        self.current_stage = current_stage
        self.attempted_stage = attempted_stage
        super().__init__(f"{message} (patch: {patch_id}, from {current_stage.value} to {attempted_stage.value})")
...
class PatchApprovalBridgeProtocol:
    ...
    def submit_verdict(self, patch_id: str, verdict: StageVerdict, actor: str, notes: str = "") -> bool:
...
class PatchPipelineProtocol:
    ...
    def advance_stage(self, patch_id: str, new_stage: PatchStage, actor: str) -> bool:
        ...
        return is_legal_transition(get_patch_registry().get_patch(patch_id).stage, new_stage) if get_patch_registry().get_patch(patch_id) else False
    ...
    def submit_verdict(self, patch_id: str, verdict: StageVerdict, actor: str, notes: str = "") -> bool:
        """Submit a verdict for a patch"""
        return get_patch_registry().approve_patch(patch_id) if verdict == StageVerdict.APPROVED else False
...
class PatchRegistry:
    ...
    def __init__(self):
        ...
        self._patches_by_stage: Dict[PatchStage, List[str]] = {
            stage: [] for stage in PatchStage
        }
