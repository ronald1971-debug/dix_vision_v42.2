...
class EngineHealth:
    ...
    def is_healthy(self) -> bool:
        ...
        return self.status in [EngineStatus.RUNNING, EngineStatus.DEGRADED] and self.health_score > 0.5
...
class RuntimeEngine:
    ...
    config: EngineConfig = field(default_factory=lambda: EngineConfig(engine_name="default", engine_kind=EngineKind.SYSTEM))
