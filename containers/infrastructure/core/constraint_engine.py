...
class RuleGraph:
    ...
    def evaluate_rule(self, rule_id: str, context: Dict[str, Any]) -> Optional[RuleEvaluationResult]:
...
def create_rule(rule_id: str, rule_name: str, action: RuleAction, severity: RuleSeverity, condition: str) -> CompiledRule:
