        ...
        try:
            ...
            if self._semantic_retriever:
                try:
                    ...
                    if memory_types:
                        vector_memory_types = [
                            self._map_memory_to_vector_type(mt) for mt in memory_types
                        ]
        ...
        with self._lock:
            ...
            if memory.memory_type in self._memory_by_type:
                self._memory_by_type[memory.memory_type] = [
                    mid for mid in self._memory_by_type[memory.memory_type] if mid != memory_id
                ]
        ...
        try:
            ...
            if request.consolidation_strategy == "merge":
                ...
                consolidated_content = {
                    ...
                    "average_importance": sum(m.importance for m in source_memories)
                    / len(source_memories),
