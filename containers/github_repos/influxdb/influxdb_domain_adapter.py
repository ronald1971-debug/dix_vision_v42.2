...
This adapter translates influxdb concepts into DIX VISION's
...
class InfluxdbDomainAdapter(SystemDomainAdapter):
    """
    Domain adapter for influxdb data.
    ...
    def adapt_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """Adapt influxdb data to DIX VISION format"""
        try:
            adapted = {
                'cognitive_data': {
                    'content': data,
