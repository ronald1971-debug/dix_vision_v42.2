...
class RegimeClassifier:
    ...
    def classify_regime(self, world_context: Dict[str, Any]) -> Tuple[ExecutionRegime, float]:
        ...
        try:
            ...
            logger.debug(f"[WORLD_EXECUTION] Classified regime: {best_regime.value} (confidence: {confidence:.2f})")
...
class ParameterAdapter:
    ...
    def adapt_parameters(self, original_config: Dict[str, Any], regime: ExecutionRegime, 
                        world_context: Dict[str, Any], confidence: float = 0.75) -> WorldEnhancedConfig:
        ...
        try:
            ...
            logger.debug(f"[WORLD_EXECUTION] Applied {len(applied_adjustments)} parameter adaptations for {regime.value}")
    ...
    def _adapt_for_high_volatility(self, config: Dict[str, Any], world_context: Dict[str, Any], 
                                  confidence: float) -> Dict[str, Tuple[Any, str]]:
    ...
    def _adapt_for_low_liquidity(self, config: Dict[str, Any], world_context: Dict[str, Any],
                                confidence: float) -> Dict[str, Tuple[Any, str]]:
        ...
        if "participation_rate" in config:
            ...
            adjustments["participation_rate"] = (adjusted_rate, "significantly_reduced_for_liquidity")
    ...
    def _adapt_for_trending(self, config: Dict[str, Any], world_context: Dict[str, Any],
                          confidence: float) -> Dict[str, Tuple[Any, str]]:
    ...
    def _adapt_for_mean_reverting(self, config: Dict[str, Any], world_context: Dict[str, Any],
                                confidence: float) -> Dict[str, Tuple[Any, str]]:
    ...
    def _adapt_for_crisis(self, config: Dict[str, Any], world_context: Dict[str, Any],
                        confidence: float) -> Dict[str, Tuple[Any, str]]:
    ...
    def _adapt_for_normal(self, config: Dict[str, Any], world_context: Dict[str, Any],
                        confidence: float) -> Dict[str, Tuple[Any, str]]:
...
class WorldEnhancedExecutionWrapper:
    ...
    def _register_default_algorithms(self):
        ...
        try:
            from execution_unified.algos.execution import TWAPAlgorithm, VWAPAlgorithm, AlmgrenChrissAlgorithm
    ...
    def execute_with_world_context(self, algorithm_name: str, original_config: Dict[str, Any], 
                                  order_data: Dict[str, Any], market_context: Dict[str, Any]) -> EnhancedExecutionResult:
        ...
        try:
            ...
            execution_result = self._execute_algorithm(algorithm_name, enhanced_config.enhanced_config, order_data)
            ...
            self._update_metrics(processing_time, success=True, world_applied=world_applied, regime=regime)
            
            logger.info(f"[WORLD_EXECUTION] {algorithm_name} executed with world context (regime: {regime.value})")
            ...
            try:
                original_result = self._execute_algorithm(algorithm_name, original_config, order_data)
                ...
                processing_time = (datetime.now() - start_time).total_seconds() * 1000
                self._update_metrics(processing_time, success=False, world_applied=False, regime=ExecutionRegime.NORMAL)
    ...
    def _execute_algorithm(self, algorithm_name: str, config: Dict[str, Any], order_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if hasattr(algorithm, 'calculate_slices'):
            ...
            return {"trajectory": trajectory, "algorithm": algorithm_name, "status": "trajectory_calculated"}
        else:
    ...
    def _calculate_performance_metrics(self, execution_result: Dict[str, Any], 
                                    enhanced_config: WorldEnhancedConfig, regime: ExecutionRegime) -> Dict[str, float]:
    ...
    def _update_metrics(self, processing_time_ms: float, success: bool, world_applied: bool, regime: ExecutionRegime):
        ...
        with self._lock:
            ...
            if len(enhanced_config.applied_adjustments if 'enhanced_config' in locals() else []) > 0:
