...
class LatencyMonitor:
    ...
    def get_alerts(self, since_ns: int | None = None) -> list[LatencyAlert]:
        ...
        Returns:
            List of alerts
        """
        # Implementation note: Full alert history requires maintaining historical alert records
        # with timestamps, severity levels, and resolution status for analysis
