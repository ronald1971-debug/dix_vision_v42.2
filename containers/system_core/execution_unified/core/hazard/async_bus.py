"""
execution_engine.hazard.async_bus
DIX VISION v42.2 — Non-Blocking Hazard Event Bus

Migrated from execution/hazard/async_bus.py
...
class HazardBus:
    ...
    def start(self) -> None:
        ...
        if self._worker is not None and self._worker.is_alive():
            return
        self._worker = threading.Thread(target=self._dispatch_loop, daemon=True, name="HazardBus")
        self._worker.start()
