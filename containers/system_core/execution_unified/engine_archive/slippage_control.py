...
class SlippageController:
    ...
    def analyze_order(
        ...
        with self._lock:
            ...
            symbol_history = self._trade_history.get(
                symbol, deque(maxlen=self._config.history_size)
            )
    ...
    def _update_symbol_metrics(self, symbol: str) -> None:
        ...
        volume_impacts = [
            self._calculate_volume_impact(trade.quantity, trade.volume) for trade in history
        ]
