...
class TradeExecutor:
    ...
    def execute(self, event: Any) -> ExecuteResult:
        ...
        try:
            ...
            _logger.warning(f"Governance check failed: {e}")
            _logger.debug("Convergence layer not booted, allowing fallthrough")
        ...
        try:
            ...
            _logger.warning(f"Reconciliation wiring failure: {e}")
            _logger.debug("Fill reconciliation failed, but execution continues")
