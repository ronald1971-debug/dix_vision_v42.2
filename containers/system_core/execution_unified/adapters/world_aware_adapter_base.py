...
class WorldAwareAdapterBase:
    ...
    def execute_order(
        ...
        try:
            ...
            logger.info(f"[{self._adapter_name}] Order executed: {order_id}, latency: {latency_ms:.2f}ms")
    ...
    def get_metrics(self) -> AdapterMetrics:
        ...
        with self._lock:
            ...
            if self._connection_start_time and self._connection_status == ConnectionStatus.CONNECTED:
                self._metrics.connection_uptime_seconds = (
                    (datetime.utcnow() - self._connection_start_time).total_seconds()
                )
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metrics": {
                ...
                "success_rate": metrics.successful_orders / metrics.total_orders if metrics.total_orders > 0 else 0.0,
