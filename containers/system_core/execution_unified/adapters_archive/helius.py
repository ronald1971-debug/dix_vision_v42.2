...
def helius_http_transport_factory(
    *,
    ...
    try:
        ...
        raise ImportError(
            "helius_http_transport_factory requires the optional 'helius-py' package "
            "— install with 'pip install helius-py' "
            "(NEW_PIP_DEPENDENCIES in execution_engine/adapters/helius.py flags this)."
        ) from exc
