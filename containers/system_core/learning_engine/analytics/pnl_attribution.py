...
from typing import TYPE_CHECKING, Dict, Final, Literal, Optional, Tuple
...
class PolarsPnLReport:
    ...
    performance_by_regime: Dict[str, float] = dataclasses.field(
        default_factory=dict
    )  # Phase 11.1 enhancement
...
class WorldAwarePnLAnalyzer:
    ...
    def _calculate_performance_by_regime(
        self, report: PolarsPnLReport, world_context: Optional[WorldContext]
    ) -> Dict[str, float]:
