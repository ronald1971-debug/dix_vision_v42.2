...
def enable_great_expectations_factory() -> Callable[
    ...
    try:
        ...
        raise ImportError(
            "enable_great_expectations_factory requires the optional "
            "'great_expectations' package — install with "
            "'pip install great_expectations' "
            "(NEW_PIP_DEPENDENCIES in system_engine/data_quality.py flags this)."
        ) from exc
