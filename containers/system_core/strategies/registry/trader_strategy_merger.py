...
class TraderStrategyMerger:
    ...
    def __init__(
        self, archetypes_path: str, strategy_registry_path: str, enhancement_system_path: str
    ):
            ...
            enhanced_archetype = {
                **archetype_data,
                "enhanced_fields": {
                    ...
                    "category_enhancement": self._get_category_enhancement(
                        enhancement_system, category_mapping
                    ),
                },
            }
            ...
            if strategy_mapping:
                merged_data["archetype_strategy_mappings"][archetype_id] = {
                    ...
                    "compatibility_score": self._calculate_compatibility_score(
                        archetype_data, strategies.get(strategy_mapping, {})
                    ),
                }
    ...
    def _get_category_enhancement(
        self, enhancement_system: Dict[str, Any], category_mapping: str
    ) -> Dict[str, Any]:
    ...
    def _calculate_compatibility_score(
        self, archetype: Dict[str, Any], strategy: Dict[str, Any]
    ) -> float:
    ...
    def _create_category_matrix(
        self,
        archetypes: Dict[str, Any],
        strategies: Dict[str, Any],
        enhancement_system: Dict[str, Any],
    ) -> Dict[str, Any]:
        """Create category-strategy-archetype matrix"""
        matrix = {}
        ...
        for archetype_id, archetype_data in archetypes.items():
            ...
            if category_mapping in matrix:
                ...
                matrix[category_mapping]["complexity_score"] = max(
                    matrix[category_mapping]["complexity_score"], 1.0 - complexity
                )
