...
class StrategyRegistryValidator:
    ...
    def validate_strategy(self, strategy_id: str, strategy_data: Dict[str, Any]) -> ValidationResult:
        ...
        # Required fields
        required_fields = [
            'id', 'name', 'category', 'base_trader', 'philosophy',
            'timeframe', 'risk', 'execution', 'regime_bias'
        ]
        ...
        if strategy_data.get('ai_enhancement_ready') and not strategy_data.get('learning_capability'):
    ...
    def validate_ensemble(self, ensemble_id: str, ensemble_data: Dict[str, Any], 
                         registry: Dict[str, Any]) -> ValidationResult:
        ...
        if 'components' in ensemble_data:
            weights = [comp.get('weight', 0) for comp in ensemble_data['components'] 
...
def main():
    ...
    registry_path = "c:/dix_vision_v42.2/containers/system_core/strategies/registry/strategy_registry.yaml"
    ...
    # Save report to file
    report_path = "c:/dix_vision_v42.2/containers/system_core/strategies/registry/validation_report.txt"
