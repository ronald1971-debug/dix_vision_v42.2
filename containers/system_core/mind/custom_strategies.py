...
class MomentumStrategy(TradingStrategy):
    ...
    def __init__(self, strategy_id: str, lookback_period: int = 20, threshold: float = 0.02):
        super().__init__(strategy_id, StrategyType.MOMENTUM)
        self.parameters = {"lookback_period": lookback_period, "threshold": threshold}
...
class MeanReversionStrategy(TradingStrategy):
    ...
    def __init__(self, strategy_id: str, lookback_period: int = 20, std_dev_threshold: float = 2.0):
...
class TrendFollowingStrategy(TradingStrategy):
    ...
    def __init__(self, strategy_id: str, fast_period: int = 10, slow_period: int = 30):
...
def _initialize_default_strategies():
    ...
    default_momentum = MomentumStrategy(
        strategy_id="default_momentum", lookback_period=20, threshold=0.02
    )
    _strategy_manager.register_strategy(default_momentum)

    default_mean_reversion = MeanReversionStrategy(
        strategy_id="default_mean_reversion", lookback_period=20, std_dev_threshold=2.0
    )
    _strategy_manager.register_strategy(default_mean_reversion)

    default_trend = TrendFollowingStrategy(
        strategy_id="default_trend_following", fast_period=10, slow_period=30
    )
