...
class DesktopAgentWorldIntegration:
    ...
    def __init__(self, agent_id: str = "desktop_agent_primary"):
        ...
        logger.info(
            f"[DESKTOP_AGENT_INTEGRATION] Desktop Agent integration initialized for {agent_id}"
        )
    ...
    def get_world_state(self) -> Dict[str, Any]:
        ...
        if self._shared_reality:
            return self._shared_reality.get_shared_state(SystemType.DESKTOP_AGENT, self._agent_id)
        return {}
...
def get_desktop_agent_integration(
    agent_id: str = "desktop_agent_primary",
