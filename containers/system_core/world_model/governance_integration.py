...
class GovernanceWorldIntegration:
    ...
    def __init__(self, governance_id: str = "governance_primary"):
        ...
        logger.info(f"[GOVERNANCE_INTEGRATION] Governance integration initialized for {governance_id}")
    ...
    def subscribe_to_world_updates(self, callback: callable) -> None:
        ...
        if self._shared_reality:
            ...
            logger.info("[GOVERNANCE_INTEGRATION] Subscribed to world updates for compliance monitoring")
...
def get_governance_integration(governance_id: str = "governance_primary") -> GovernanceWorldIntegration:
