...
class CognitiveOSWorldIntegration:
    ...
    def __init__(self, cognitive_os_id: str = "cognitive_os_primary"):
        ...
        logger.info(
            f"[COGNITIVE_OS_INTEGRATION] Cognitive OS integration initialized for {cognitive_os_id}"
        )
    ...
    def get_world_state_for_cognitive_processing(self) -> Dict[str, Any]:
        ...
        if self._shared_reality:
            return self._shared_reality.get_shared_state(
                SystemType.COGNITIVE_OS, self._cognitive_os_id
            )
        return {}
    ...
    def subscribe_to_world_updates(self, callback: callable) -> None:
        ...
        if self._shared_reality:
            ...
            logger.info(
                "[COGNITIVE_OS_INTEGRATION] Subscribed to world updates for cognitive processing"
            )
...
def get_cognitive_os_integration(
    cognitive_os_id: str = "cognitive_os_primary",
