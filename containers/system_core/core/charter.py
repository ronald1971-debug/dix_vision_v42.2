...
Each voice (INDIRA / DYON / GOVERNANCE / COGNITIVE_GOVERNANCE) declares
WHAT it is, HOW it operates, WHY (manifest § citations), what it MUST NOT
do, and how it is AUDITED. The chat introspection API ("what/how/why are
you doing X?") reads this to answer grounded in each voice's declared role.
