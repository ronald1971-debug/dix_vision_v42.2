"""Belief State — read-only project of system regime, market context, and cognition state.

Phase 6.T1b — expanded reality domains.

Design (v3.1 §B1, v3.3 §1.2, v42.2 §2):
...
Reality Domains (INV-DIX-02):

* market reality — price, volatility, regime, consensus
* trader reality — trader profiles, preferences, behavior patterns
* strategy reality — strategy performance, hypotheses, rankings
* portfolio reality — allocation, exposure, correlation, capital
* execution reality — fill data, slippage, latency, reconciliation
* system reality — health, latency, resource utilization

All engines contribute to BeliefState via their reality domain.
...
BELIEF_STATE_VERSION = "v42.2-T1b"
