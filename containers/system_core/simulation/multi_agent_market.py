...
class MomentumAgent:
    ...
    def on_fill(self, fill: SimFill) -> None:
        LOG.debug(f"BaseAgent {self.agent_id} received fill: {fill}")
        LOG.warning("Using empty on_fill implementation - placeholder")
...
class MeanReversionAgent:
    ...
    def on_fill(self, fill: SimFill) -> None:
        LOG.debug(f"MeanReversionAgent {self.agent_id} received fill: {fill}")
        LOG.warning("Using empty on_fill implementation - placeholder")
...
class NoiseAgent:
    ...
    def on_fill(self, fill: SimFill) -> None:
        LOG.debug(f"NoiseAgent {self.agent_id} received fill: {fill}")
        LOG.warning("Using empty on_fill implementation - placeholder")
                ...
                for agent in self._agents:
                    if agent.agent_id == fill.agent_id:
                        try:
                            ...
                            LOG.warning(f"Agent {agent.agent_id} failed to process fill: {e}")
                            LOG.debug("Will continue with other agents")
