...
class SimulationDominanceRuntime:
    ...
    def _collect_genomes(self, ts_ns: int) -> list[Any]:
        ...
        try:
            ...
            LOG.warning(f"Failed to add genome proposals to dominance runtime: {e}")
            LOG.debug("Will continue with synthetic genomes if needed")
        ...
        try:
            ...
            LOG.warning(f"Failed to create synthetic genomes: {e}")
            LOG.debug("Will continue with existing genomes")
    ...
    def _emit_tournament_result(self, result: Any, ts_ns: int) -> None:
        ...
        try:
            ...
            LOG.warning(f"Failed to log dominance result to event bus: {e}")
            LOG.debug("Will continue with other event logging")
        try:
            ...
            LOG.warning(f"Failed to log dominance tournament to ledger: {e}")
            LOG.debug("Will continue with other event logging")
