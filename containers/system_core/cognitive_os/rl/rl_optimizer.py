...
class ReinforcementLearningOptimizer:
    ...
    def make_decision(self, state: Dict[str, Any], available_actions: List[Dict[str, Any]]) -> RLDecision:
    ...
    def update_experience(self, state: Dict[str, Any], action: Dict[str, Any], 
    ...
    def calculate_reward(self, execution_result: Dict[str, Any], risk_metrics: Dict[str, float]) -> float:
        """Calculate reward based on execution results and risk metrics."""
        return self._reward_calculator.calculate_reward(execution_result, risk_metrics, self._reward_type)
    ...
    def improve_policy(self) -> None:
        ...
        logger.info(f"[RL_OPTIMIZER] Policy improvement complete, exploration rate: {self._exploration_rate}")
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                "recent_performance": np.mean(self._reward_history[-10:]) if len(self._reward_history) >= 10 else 0.0,
    ...
    def _perform_learning_update(self) -> None:
        ...
        with self._lock:
            ...
            for idx in batch_indices:
                ...
                state_key = self._generate_state_key(state_encoding)
                next_state_key = self._generate_state_key(next_state_encoding) if next_state_encoding else None
                ...
                # Update Q-value
                self._q_table[state_key][action_index] = current_q + self._learning_rate * (target_q - current_q)
...
class RewardCalculator:
    ...
    def calculate_reward(self, execution_result: Dict[str, Any], risk_metrics: Dict[str, float], 
                       reward_type: RewardType) -> float:
    ...
    def _risk_adjusted_reward(self, execution_result: Dict[str, Any], risk_metrics: Dict[str, float]) -> float:
    ...
    def _utility_based_reward(self, execution_result: Dict[str, Any], risk_metrics: Dict[str, float]) -> float:
    ...
    def _preference_based_reward(self, execution_result: Dict[str, Any], risk_metrics: Dict[str, float]) -> float:
    ...
    def _multi_objective_reward(self, execution_result: Dict[str, Any], risk_metrics: Dict[str, float]) -> float:
...
class PolicyImprover:
    ...
    def improve(self, q_table: Dict[str, np.ndarray], experiences: List[RLExperience],
                learning_rate: float, discount_factor: float) -> Dict[str, Any]:
        """Improve policy using collected experience."""
        improvement_metrics = {
            "states_updated": 0,
            "value_changes": [],
