...
class DriftMonitor:
    ...
    def __init__(self):
        ...
        self._correlation_tracking: Dict[Tuple[str, str], List[Tuple[datetime, float]]] = defaultdict(list)
    ...
    def _trigger_drift_callbacks(self, drift_type: DriftType, measurement: DriftMeasurement) -> None:
    ...
    def register_drift_callback(self, drift_type: DriftType, callback: Callable[[DriftMeasurement], None]) -> None:
