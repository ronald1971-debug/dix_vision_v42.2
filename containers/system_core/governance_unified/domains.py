...
class DomainGovernanceManager:
    ...
    def create_policy(
        self, policy_id: str, domain: GovernanceDomain, title: str, description: str
    ) -> CognitiveGovernancePolicy:
        """Create new governance policy"""
        policy = CognitiveGovernancePolicy(
            policy_id=policy_id, domain=domain, title=title, description=description
        )
...
def create_cognitive_policy(
    policy_id: str, title: str, description: str
) -> CognitiveGovernancePolicy:
