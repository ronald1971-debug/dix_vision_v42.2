    ...
    * **IVF (approximate)** — caller supplies a frozen tuple of
    ...
    def _emit_memory_formation(episode: Episode) -> None:
        ...
        try:
            ...
            content = episode.payload.get("content_summary", f"semantic vector dim={episode.dim}")
            ...
            LOG.warning(f"Failed to create semantic memory embedding: {e}")
            LOG.debug("Will continue with episode storage without embedding")
