...
class ProductionScenarioGenerator:
    ...
    def generate_market_stress_scenario(
        ...
        stressed_correlation = min(
            1.0, base_conditions.correlation + stress_params.shock_magnitude * 0.3
        )
    ...
    def generate_volatility_spike_scenario(
        ...
        self._scenarios.append(scenario)
        logger.info(
            f"[SCENARIO_GENERATOR] Generated volatility spike scenario: {scenario.scenario_id}"
        )
        return scenario
    ...
    def generate_liquidity_crisis_scenario(
        ...
        self._scenarios.append(scenario)
        logger.info(
            f"[SCENARIO_GENERATOR] Generated liquidity crisis scenario: {scenario.scenario_id}"
        )
        return scenario
    ...
    def generate_correlation_break_scenario(
        ...
        self._scenarios.append(scenario)
        logger.info(
            f"[SCENARIO_GENERATOR] Generated correlation break scenario: {scenario.scenario_id}"
        )
        return scenario
