...
class RuntimeContext:
    ...
    async def stop_monitoring(self) -> None:
        ...
        if self._monitoring_task:
            ...
            try:
                ...
                LOG.debug("Monitoring task cancelled as expected during shutdown")
    ...
    async def _update_system_metrics(self) -> None:
        ...
        try:
            ...
            self._network_latency_ms = 1.0  # Implementation note: Real latency requires ICMP ping or network monitoring
            ...
            self._system_load = 0.5  # Implementation note: Would use system-specific monitoring if psutil unavailable
            self._available_memory_mb = 4096.0  # 4GB implementation note
            self._active_threads = 10  # Implementation note
            self._network_latency_ms = 5.0  # Implementation note for fallback
            self._disk_io_mb_per_sec = 50.0  # Implementation note for fallback
        except Exception as e:
