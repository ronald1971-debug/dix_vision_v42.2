...
class NewsKnowledgeIndex:
    ...
    def _analyze_sentiment(self, title: str, content: str) -> str:
        ...
        positive_words = ['growth', 'increase', 'positive', 'rise', 'gain', 'profit', 'success', 'optimistic']
        negative_words = ['decline', 'decrease', 'negative', 'fall', 'loss', 'crisis', 'risk', 'pessimistic']
    ...
    def _extract_entities(self, title: str, content: str) -> Dict[str, List[str]]:
        ...
        financial_entities = ['federal reserve', 'sec', 'market', 'stock', 'bond', 'currency', 'inflation', 'interest rate']
    ...
    def get_causal_factor_statistics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            return {
                ...
                "causal_factors": {factor: len(history) for factor, history in self._causal_factor_history.items()},
