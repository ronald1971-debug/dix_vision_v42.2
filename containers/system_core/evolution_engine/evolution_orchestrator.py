...
class EvolutionOrchestrator:
    ...
    def __init__(self, *, dyon_runtime: DyonRuntime | None = None) -> None:
        self.name = "evolution_orchestrator"
    ...
    def activate(self) -> None:
        """Activate the orchestrator. Idempotent."""
        if self._active:
            return
        self._active = True
        _logger.info("EvolutionOrchestrator: activated")
    ...
    def check_health(self) -> dict[str, Any]:
        ...
        return {
            ...
            "has_structural_loop": self._structural_loop is not None,
            "has_critique_loop": self._critique_loop is not None,
            "has_arena": self._arena is not None,
        }
    ...
    def _try_auto_wire_critique(self) -> None:
        try:
            ...
            _logger.warning(f"Failed to auto-wire CritiqueLoop: {e}")
            _logger.debug("EvolutionOrchestrator will continue without CritiqueLoop integration")
