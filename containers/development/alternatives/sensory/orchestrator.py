...
class SensoryOrchestrator:
    ...
    def _initialize_sensors(self) -> None:
        ...
        sensors = [
            ...
            SensorHealth(
                sensor_name="alternative_sensor", sensor_type="alternative", is_active=True
            ),
        ]
    ...
    def sense_market(self, market_context: dict[str, Any]) -> SensorData:
        ...
        if not self._market_sensor_enabled:
            ...
            return SensorData(
                sensor_name="market_sensor", sensor_type="market", data={}, confidence=0.0
            )
    ...
    def sense_news(self, news_context: dict[str, Any]) -> SensorData:
        ...
        if not self._news_sensor_enabled:
            ...
            return SensorData(
                sensor_name="news_sensor", sensor_type="news", data={}, confidence=0.0
            )
    ...
    def sense_social(self, social_context: dict[str, Any]) -> SensorData:
        ...
        if not self._social_sensor_enabled:
            ...
            return SensorData(
                sensor_name="social_sensor", sensor_type="social", data={}, confidence=0.0
            )
    ...
    def sense_macro(self, macro_context: dict[str, Any]) -> SensorData:
        ...
        if not self._macro_sensor_enabled:
            ...
            return SensorData(
                sensor_name="macro_sensor", sensor_type="macro", data={}, confidence=0.0
            )
    ...
    def sense_onchain(self, onchain_context: dict[str, Any]) -> SensorData:
        ...
        if not self._onchain_sensor_enabled:
            ...
            return SensorData(
                sensor_name="onchain_sensor", sensor_type="onchain", data={}, confidence=0.0
            )
    ...
    def sense_alternative(self, alternative_context: dict[str, Any]) -> SensorData:
        ...
        if not self._alternative_sensor_enabled:
            ...
            return SensorData(
                sensor_name="alternative_sensor", sensor_type="alternative", data={}, confidence=0.0
            )
    ...
    def fuse_sensors(self, sensor_data_list: list[SensorData]) -> dict[str, Any]:
        ...
        try:
            ...
            fused_data = {
                ...
                "confidence_average": (
                    sum(d.confidence for d in sensor_data_list) / len(sensor_data_list)
                    if sensor_data_list
                    else 0.0
                ),
