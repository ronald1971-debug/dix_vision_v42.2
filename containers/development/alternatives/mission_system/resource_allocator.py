...
class ProductionResourceAllocator:
    ...
    def allocate_resource(self, mission_id: str, resource_type: str, amount: float) -> ResourceAllocation:
        ...
        allocation = ResourceAllocation(
            ...
            utilization=amount / self._capacities[resource_type] if self._capacities[resource_type] > 0 else 0.0,
    ...
    def get_utilization(self, resource_type: str) -> float:
        ...
        total_allocated = sum(a.allocated_amount for a in self._allocations if a.resource_type == resource_type)
        return total_allocated / self._capacities[resource_type] if self._capacities[resource_type] > 0 else 0.0
