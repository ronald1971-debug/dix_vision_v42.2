...
def test_qr_version_selection():
    ...
    try:
        ...
        print(
            f"[PASS] Very large text uses version corresponding to {size_very_large}x{size_very_large}"
        )
...
def test_qr_error_correction():
    ...
    from cognitive_control_center.shared_services.qr import _FORMAT_TABLE_L, _VERSIONS, encode_qr
