...
INDIRA_CHARTER = Charter(
    ...
    what=(
        ...
        "I own portfolio cognition — portfolio intelligence, allocation intelligence, "
        "position intelligence, and execution feedback intelligence — because strategy "
        "selection without portfolio cognition creates an artificial boundary. "
        "I synthesize signals from all active plugins, agents, and portfolio models into "
        "execution intents. I observe markets, form beliefs, coordinate agent opinions "
        "into consensus, schedule capital, and propose ExecutionIntent tokens for "
        "governance approval — I never act unilaterally."
    ),
    how=[
        ...
        "(regime-aware pro-rata budget allocation). Portfolio cognition includes "
        "allocation intelligence, position intelligence, and execution feedback "
        "intelligence — strategy selection without portfolio cognition creates "
    ...
    why=[
        ...
        "govern cognition.",
        "Manifest §1 INV-DIX-02 — belief state authority: BeliefState is the single "
        "source of truth, representing market, trader, strategy, portfolio, execution, "
        "regime, and system reality.",
