...
class AlertingSystem:
    ...
    def add_alert_rule(self, rule_id: str, rule_name: str, metric_name: str,
                     condition: str, threshold: float, severity: AlertSeverity,
                     cooldown_minutes: int = 5, metadata: Dict[str, Any] = None) -> bool:
    ...
    def evaluate_rules(self, metrics: Dict[str, float]) -> List[Alert]:
        ...
        for rule in self.alert_rules:
            ...
            if condition_met:
                ...
                self.alert_suppressions[rule.rule_id] = datetime.now() + timedelta(minutes=rule.cooldown_minutes)
    ...
    def get_active_alerts(self) -> List[Alert]:
        ...
        return [alert for alert in self.alerts if alert.status in [AlertStatus.NEW, AlertStatus.ACKNOWLEDGED]]
