...
class IntegrationTestingFramework:
    ...
    def add_test_case(self, test_id: str, test_name: str, test_category: TestCategory,
                     test_priority: TestPriority, test_function: Any,
                     timeout_seconds: int = None, dependencies: List[str] = None,
                     description: str = "", expected_result: str = None,
        ...
        logger.info("Test case added", test_id=test_id, test_name=test_name, category=test_category.value)
        return True
    
    def create_test_suite(self, suite_id: str, suite_name: str, 
        ...
        logger.info("Test suite created", suite_id=suite_id, suite_name=suite_name, total_tests=len(sorted_tests))
        return True
    ...
    def _execute_with_timeout_sync(self, test_case: TestCase) -> TestResult:
        ...
        try:
            ...
            test_args = {
                'component_interfaces': self.component_interfaces,
                'config': self.config
            }
            ...
            if isinstance(result, bool):
                ...
                if test_case.expected_result:
                    status = TestStatus.PASSED if str(result) == test_case.expected_result else TestStatus.FAILED
    ...
    def get_test_history(self) -> List[Dict[str, Any]]:
        ...
        return [report.to_dict() if hasattr(report, 'to_dict') else report for report in self.execution_history]