...
class PresenceOrchestrator:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "component_statuses": {
                "presence_detector": self._presence_detector.get_status() if self._presence_detector else None,
                "user_tracker": self._user_tracker.get_status() if self._user_tracker else None,
                "activity_monitor": self._activity_monitor.get_status() if self._activity_monitor else None,
            },
        }