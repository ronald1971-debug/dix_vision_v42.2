...
class ActivityMonitor:
    ...
    def __init__(self):
        ...
        self._activity_statistics: Dict[str, Dict[str, Any]] = defaultdict(lambda: {
            "count": 0,
            "duration": 0,
            "last_seen": None
        })
    ...
    async def initialize(self, config: Optional[Dict[str, Any]] = None) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Activity Monitor configured: max_events={self._config['max_events']}")
    ...
    async def record_activity(
        ...
        try:
            if len(self._activity_events) >= self._config['max_events']:
                ...
                self._activity_events = self._activity_events[-int(self._config['max_events'] * 0.9):]
