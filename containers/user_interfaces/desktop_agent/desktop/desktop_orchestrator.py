...
class DesktopOrchestrator:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "component_statuses": {
                "desktop_controller": (
                    self._desktop_controller.get_status() if self._desktop_controller else None
                ),
                "application_manager": (
                    self._application_manager.get_status() if self._application_manager else None
                ),
                "window_manager": (
                    self._window_manager.get_status() if self._window_manager else None
                ),
            },
        }
