...
class ApplicationManager:
    ...
    async def initialize(self, config: Optional[Dict[str, Any]] = None) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Application Manager configured: max_applications={self._config['max_applications']}")
    ...
    async def start_application(
        ...
        try:
            if len(self._applications) >= self._config['max_applications']:
                self.logger.warning(f"Maximum applications reached: {self._config['max_applications']}")
                return False
