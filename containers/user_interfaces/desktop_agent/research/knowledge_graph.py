...
class KnowledgeGraph:
    ...
    def __init__(self):
        ...
        self._adjacency_list: Dict[str, Dict[str, List[str]]] = defaultdict(lambda: defaultdict(list))
    ...
    async def find_related_nodes(
        ...
        try:
            ...
            while queue:
                ...
                # Get neighbors
                edge_types = [edge_type.value] if edge_type else list(self._adjacency_list[current_node_id].keys())
