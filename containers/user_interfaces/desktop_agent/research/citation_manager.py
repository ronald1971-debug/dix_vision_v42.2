...
class CitationManager:
    ...
    async def initialize(self, config: Optional[Dict[str, Any]] = None) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Citation Manager configured: max_citations={self._config['max_citations']}")
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "config": {
                ...
                "default_format": self._config["default_format"].value if isinstance(self._config.get("default_format"), CitationFormat) else self._config.get("default_format"),
