...
class LearningOrchestrator:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "component_statuses": {
                "platform_profiler": self._platform_profiler.get_status() if self._platform_profiler else None,
                "workflow_profiler": self._workflow_profiler.get_status() if self._workflow_profiler else None,
