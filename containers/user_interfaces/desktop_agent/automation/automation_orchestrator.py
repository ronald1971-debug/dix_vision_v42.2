...
class AutomationOrchestrator:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "component_statuses": {
                "automation_engine": self._automation_engine.get_status() if self._automation_engine else None,
                "workflow_automator": self._workflow_automator.get_status() if self._workflow_automator else None,
