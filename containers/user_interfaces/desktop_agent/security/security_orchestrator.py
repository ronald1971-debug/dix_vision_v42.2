...
class SecurityOrchestrator:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "component_statuses": {
                "security_manager": self._security_manager.get_status() if self._security_manager else None,
                "access_control": self._access_control.get_status() if self._access_control else None,
