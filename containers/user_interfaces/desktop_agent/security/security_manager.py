...
class SecurityManager:
    ...
    def evaluate_security_policy_with_world_context(self, 
                                                   policy_id: str, 
                                                   user_id: str,
                                                   action: str,
                                                   world_context: Optional[WorldContext] = None) -> Dict[str, Any]:
        """
    ...
    def _evaluate_standard_security_policy(self, policy_id: str, user_id: str, action: str) -> Dict[str, Any]:
...
class AccessControl:
    ...
    def check_access_with_world_context(self,
                                        user_id: str,
                                        resource: str,
                                        action: str,
                                        world_context: Optional[WorldContext] = None) -> Dict[str, Any]:
...
class AuditLogger:
    ...
    def log_security_event_with_world_context(self,
                                             event_type: str,
                                             user_id: str,
                                             details: Dict[str, Any],
                                             world_context: Optional[WorldContext] = None) -> str:
        """
