    ...
    def _broadcast(self, msg: WSMessage) -> int:
        ...
        for client in self._clients:
            try:
                ...
                # WebSocket send failures are common with disconnected clients
                # Log and continue with other clients
                self.logger.warning(f"WebSocket send failed for client: {e}")
                self.logger.debug("Continuing with other clients")
