...
function AppContent() {
  ...
  if (popout) {
    ...
    // The enhanced system status banner renders world-aware monitoring
    // so the operator always knows the system state and connectivity.
    return (
