        ...
        try:
            while not self._stop_event.is_set():
                ...
                try:
                    ...
                    if conn is not None:
                        try:
                            ...
                            LOG.warning(f"solana_launch_ws: error closing connection: {e}")
                            LOG.debug("continuing with other operations")
                ...
                try:
                    ...
                    LOG.debug("solana_launch_ws: timeout waiting for stop event, continuing")
                    LOG.debug("continuing with other operations")
            ...
            try:
                ...
                LOG.warning(f"solana_launch_ws: error closing HTTP client: {e}")
                LOG.debug("continuing with other operations")
