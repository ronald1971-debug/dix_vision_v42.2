...
paths_to_add = [
    ...
    os.path.join(project_root, 'containers', 'system_core', 'system_engine'),  # Unified system_engine
    ...
    os.path.join(project_root, 'containers', 'system_core', 'governance_unified', 'domains', 'cognitive'),
