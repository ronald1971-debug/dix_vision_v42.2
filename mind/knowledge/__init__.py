...
from mind.knowledge.base import (  # noqa: F401 — re-export for backward compat
    KnowledgeBase,
    KnowledgeItem,
)
...
__all__ = [
    "KnowledgeBase",  # Re-exported from .base for backward compat
    "KnowledgeItem",  # Re-exported from .base for backward compat
    "DriftMonitor",
    "get_drift_monitor",
    "EdgeCaseMemory",
