...
class TradingIntent:
    ...
    confidence_breakdown: Dict[str, float] = field(default_factory=dict)  # Enhanced: confidence breakdown
    timestamp_utc: str = ""
    metadata: Dict[str, Any] = field(default_factory=dict)
...
class INDIRAMindInterface(ABC):
    ...
    def allocate_attention(
        ...
        attention_type: AttentionType = AttentionType.ADAPTIVE
    ) -> Dict[str, float]:
...
class EnhancedINDIRAMind(INDIRAMindInterface):
    ...
    def assess_self_performance(self) -> SelfAwarenessLevel:
        ...
        return performance_assessment.performance_rating >= 0.7 and SelfAwarenessLevel.CONFIDENT or SelfAwarenessLevel.COMPETENT
