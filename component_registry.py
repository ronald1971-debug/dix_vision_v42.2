...
class UnifiedComponentRegistry:
    ...
    def register_component(self, component_name: str, module_path: str, 
                        component_class_name: str, dependencies: List[str] = None):
    ...
    def register_all_archival_components(self):
        ...
        for component_name, info in execution_components.items():
            self.register_component(component_name, info['module'], info['class'], info.get('dependencies'))
