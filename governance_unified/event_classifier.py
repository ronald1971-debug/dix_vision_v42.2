...
_AUDIT_ONLY_SYSTEM_KINDS: Final[frozenset[SystemEventKind]] = frozenset(
    {
        ...
        # Cognitive Governance Audit Engine events (COGOV_*)
        SystemEventKind.COGOV_BELIEF_INTEGRITY_REPORT,
        SystemEventKind.COGOV_CAUSAL_CONSISTENCY,
        SystemEventKind.COGOV_EPISTEMIC_DRIFT,
        SystemEventKind.COGOV_HALLUCINATION_DETECTED,
        SystemEventKind.COGOV_IDENTITY_STABILITY,
        SystemEventKind.COGOV_INTEGRITY_STATUS,
        SystemEventKind.COGOV_LEARNING_TRUTHFULNESS,
        SystemEventKind.COGOV_LINEAGE_VALIDATED,
        SystemEventKind.COGOV_MEMORY_CONTAMINATION,
        SystemEventKind.COGOV_MUTATION_VALIDATED,
        SystemEventKind.COGOV_REWARD_HACKING,
        SystemEventKind.COGOV_SYNTHETIC_FEEDBACK,
        # Belief lifecycle events
        SystemEventKind.BELIEF_CONTRADICTION_DETECTED,
        SystemEventKind.BELIEF_CONTRADICTION_RESOLVED,
        SystemEventKind.BELIEF_EVIDENCE_ADDED,
        SystemEventKind.BELIEF_LINEAGE_UPDATED,
        SystemEventKind.BELIEF_REVISED,
        SystemEventKind.EVIDENCE_REWEIGHED,
        # Learning / Research events
        SystemEventKind.BROWSER_RESEARCH_OBSERVATION,
        SystemEventKind.KNOWLEDGE_GAP_RAISED,
        SystemEventKind.LEARNING_PROCESS_OPTIMIZED,
        SystemEventKind.LEARNING_SHADOW_TICK,
        SystemEventKind.MANUAL_ORDER_SUBMITTED,
        SystemEventKind.META_LEARNING_REPORT,
        SystemEventKind.OPERATOR_AUTHORITY_CHANGED,
        SystemEventKind.SEMI_AUTO_APPROVAL_REQUESTED,
        SystemEventKind.SEMI_AUTO_APPROVED,
        SystemEventKind.SEMI_AUTO_EXIT_FIRED,
        SystemEventKind.SEMI_AUTO_POLICY_CHANGED,
        SystemEventKind.SEMI_AUTO_REJECTED,
        SystemEventKind.STRATEGY_ATOM_INGESTED,
        SystemEventKind.STRATEGY_COMPOSED,
        # Execution / Trading events
        SystemEventKind.BACKTEST_EXECUTED,
        SystemEventKind.LIVE_EXECUTION_BLOCKED,
        SystemEventKind.LIVE_PARAM_PROMOTED,
        SystemEventKind.LIVE_PARAM_REVERTED,
        SystemEventKind.PAPER_EXECUTED,
        SystemEventKind.TRADING_MODE_CHANGED,
        SystemEventKind.TRADER_PROFILE_PROMOTED,
        # Failure / Source events
        SystemEventKind.FAILURE_CLASSIFIED,
        SystemEventKind.FAILURE_PATTERN_DETECTED,
        SystemEventKind.EXTERNAL_SOURCE_INGESTED,
        SystemEventKind.SELF_MODEL_UPDATED,
        SystemEventKind.BUILDOUT_PARAM_APPLIED,
    }
)
