"""
governance_engine.domains.system.topology_guard
DIX VISION v42.2 — Topology Guard

Migrated from system_unified_unified_unified_governance/topology_guard.py
...
# Execution path modules that must not import system_unified_unified_unified infrastructure
