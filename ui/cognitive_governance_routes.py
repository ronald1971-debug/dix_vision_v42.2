...
def build_cognitive_governance_router() -> APIRouter:
    ...
    @router.get("/knowledge_lifecycle")
    def get_knowledge_lifecycle() -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "retired_count": len(manager.get_retired()),
            }
        except Exception as exc:
            return {
                "available": False,
    ...
    def get_cognitive_physics() -> dict[str, Any]:
        ...
        try:
            ...
            stats = engine.get_propagation_stats()
            return {
                "available": True,
                "total_propagations": stats.get("total_propagations", 0),
