    ...
    <section className="flex h-full flex-col">
      <header className="mb-3">
        ...
        <p className="mt-1 text-xs text-slate-400">
          ...
          monitor, and invariant compliance dashboard. All read directly
          from the canonical ledger; the decision buttons in the approval
          queue route back through the ledger so every operator action is
          itself recorded.
        </p>
      </header>
      <div className="grid flex-1 grid-cols-1 gap-3 overflow-auto pb-6 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <WidgetSlot widgetKey="governance:InvariantComplianceDashboard" className="min-h-[320px] xl:col-span-2">
          <InvariantComplianceDashboard />
        </WidgetSlot>
