...
class TestExplainableAI(unittest.TestCase):
    ...
    def test_decision_explanation(self):
        from cognitive_os.xai.explainable_ai import ExplanationType, ExplanationDetail
...
class TestAdvancedIntegrationScenarios(unittest.TestCase):
    ...
    def test_rl_xai_integration(self):
        ...
        from cognitive_os.rl.rl_optimizer import get_rl_optimizer
        from cognitive_os.xai.explainable_ai import get_explainable_ai, ExplanationType
        ...
        explanation = xai_system.explain_decision(decision_dict, context, ExplanationType.FEATURE_IMPORTANCE)
    ...
    def test_temporal_rl_integration(self):
        ...
        for i in range(5):
            temporal_reasoner.record_temporal_event(
                ...
                attributes={"volatility": 0.2 + i * 0.05}
            )
