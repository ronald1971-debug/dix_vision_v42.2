...
class KillSwitch:
    ...
    async def trigger(self, reason: KillReason, triggered_by: str, metadata: Optional[Dict[str, Any]] = None) -> bool:
...
async def trigger_kill_switch(reason: KillReason, triggered_by: str, metadata: Optional[Dict[str, Any]] = None):
