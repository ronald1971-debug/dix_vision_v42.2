...
class DyonBrainAdapter:
    ...
    def _try_new_brain(
        ...
        try:
            ...
            if self._consecutive_failures >= self._max_consecutive_failures:
                self._new_brain_healthy = False
                logger.warning(f"[DYON_ADAPTER] New brain disabled after {self._consecutive_failures} failures")
    ...
    def _convert_analysis_result(self, analysis_result: Any, issue: str, reasoning_mode: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "reasoning_mode": reasoning_mode,
            "reasoning_steps": [getattr(analysis_result, 'neural_analysis', ''), getattr(analysis_result, 'symbolic_analysis', '')],
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        new_brain_ratio = (self._new_brain_count / self._analysis_count) if self._analysis_count > 0 else 0.0
        fallback_ratio = (self._fallback_count / self._analysis_count) if self._analysis_count > 0 else 0.0
