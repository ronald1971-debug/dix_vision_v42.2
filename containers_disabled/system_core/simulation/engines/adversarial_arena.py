...
class _Frontrunner(_AdversarialAgent):
    ...
    def __init__(self, rng: random.Random) -> None:
        super().__init__("FRONTRUNNER", edge_mu=4.0, edge_sigma=2.0, base_win_rate=0.52, rng=rng)

    def _win_action(self) -> str:
        return self._rng.choice(self._ACTIONS_WIN)

    def _lose_action(self) -> str:
        return self._rng.choice(self._ACTIONS_LOSE)
...
class _Spoofer(_AdversarialAgent):
    ...
    def __init__(self, rng: random.Random) -> None:
        super().__init__("SPOOFER", edge_mu=6.0, edge_sigma=3.0, base_win_rate=0.45, rng=rng)
...
class _WhaleAccumulator(_AdversarialAgent):
    ...
    def __init__(self, rng: random.Random) -> None:
        super().__init__(
            "WHALE_ACCUMULATOR", edge_mu=8.0, edge_sigma=4.0, base_win_rate=0.40, rng=rng
        )
...
class _StopHunter(_AdversarialAgent):
    ...
    def __init__(self, rng: random.Random) -> None:
        super().__init__("STOP_HUNTER", edge_mu=10.0, edge_sigma=5.0, base_win_rate=0.38, rng=rng)
...
class _DarkPoolShark(_AdversarialAgent):
    ...
    def __init__(self, rng: random.Random) -> None:
        super().__init__(
            "DARK_POOL_SHARK", edge_mu=5.0, edge_sigma=2.5, base_win_rate=0.48, rng=rng
        )
...
__all__ = ["AdversarialTraderArena", "AgentRecord", "AgentAction", "get_adversarial_arena"]
