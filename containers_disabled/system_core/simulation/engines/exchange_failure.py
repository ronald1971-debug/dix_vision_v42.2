...
class ExchangeFailureEngine:
    ...
    def aggregate_fill_rate(self) -> float:
        ...
        with self._lock:
            rates = [
                _STATE_PROPS[_STATES[self._venue_states[v]]]["fill_rate"] for v in _VENUE_NAMES
            ]
...
__all__ = ["ExchangeFailureEngine", "VenueState", "ExchangeEvent", "get_exchange_failure_engine"]
