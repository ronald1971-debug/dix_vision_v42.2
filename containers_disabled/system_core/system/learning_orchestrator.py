...
class LearningOrchestrator:
    ...
    def record_capability_performance(
        self, capability_name: str, metrics: dict[str, float]
    ) -> None:
    ...
    def record_capability_utility(self, capability_name: str, utility_score: float) -> None:
    ...
    def record_capability_cost(self, capability_name: str, cost: float) -> None:
    ...
    def record_capability_dependency(self, capability_name: str, depends_on: str) -> None:
    ...
    def _generate_utility_insight(
        self, capability_name: str, utility_score: float
    ) -> CapabilityInsight:
    ...
    def _generate_dependency_insight(
        self, capability_name: str, dependencies: set[str]
    ) -> CapabilityInsight:
    ...
    def _generate_cost_insight(self, capability_name: str, cost: float) -> CapabilityInsight:
    ...
    def _evaluate_capability(
        self, capability_name: str, insights: list[CapabilityInsight]
    ) -> CapabilityDecision:
        ...
        # Weighted score
        performance_score = (
            sum(i.insight_value for i in performance_insights) / len(performance_insights)
            if performance_insights
            else 0.5
        )
        utility_score = (
            sum(i.insight_value for i in utility_insights) / len(utility_insights)
            if utility_insights
            else 0.5
        )
        cost_score = (
            sum(i.insight_value for i in cost_insights) / len(cost_insights)
            if cost_insights
            else 0.5
        )
