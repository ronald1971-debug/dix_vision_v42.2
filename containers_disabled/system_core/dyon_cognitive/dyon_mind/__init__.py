...
class SystemIdentity:
    ...
    def update_capability(self, capability: str, confidence_delta: float) -> None:
        ...
        self.capability_evolution[capability] = max(
            0.0, min(1.0, self.capability_evolution[capability] + confidence_delta)
        )
...
class DYONMindInterface(ABC):
    ...
    @abstractmethod
    def manage_investigation(self, investigation_id: str, action: str) -> InvestigationStatus:
        """
    ...
    @abstractmethod
    def generate_system_question(self, context: Dict[str, Any]) -> str:
        """
    ...
    def reflect_on_performance(
        self, context: Dict[str, Any], reflection_type: str = "PERFORMANCE"
...
class EnhancedDYONMind(DYONMindInterface):
    ...
    def get_curiosity_score(self, situation: Dict[str, Any]) -> CuriosityScore:
        ...
        return CuriosityScore(score=0.5, information_gain=0.4, novelty=0.6, importance=0.5)
    ...
    def reflect_on_performance(
        ...
        reflection = EngineeringReflection(
            ...
            what_could_be_improved=["Reduce investigation time", "Improve accuracy of analysis"],
            lessons_learned=[
    ...
    def get_system_self_awareness(self) -> SystemSelfAwarenessState:
        ...
        self._self_awareness_state.active_investigations = [
            inv_id for inv_id, inv in self._investigations.items() if inv.is_active
        ]
