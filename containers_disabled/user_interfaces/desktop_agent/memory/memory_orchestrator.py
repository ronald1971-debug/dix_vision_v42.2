...
class MemoryOrchestrator:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "component_statuses": {
                "memory_manager": (
                    self._memory_manager.get_status() if self._memory_manager else None
                ),
                "knowledge_store": (
                    self._knowledge_store.get_status() if self._knowledge_store else None
                ),
                "context_manager": (
                    self._context_manager.get_status() if self._context_manager else None
                ),
            },
        }
