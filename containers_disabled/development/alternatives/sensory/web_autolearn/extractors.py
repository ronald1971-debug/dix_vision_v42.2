    ...
    *,
    ...
    if extract_callable is None:
        try:
            ...
            raise ImportError(
                "trafilatura_extractor_factory requires the optional 'trafilatura' package "
                "— install with 'pip install trafilatura' "
                "(NEW_PIP_DEPENDENCIES in sensory/web_autolearn/extractors.py flags this)."
            ) from exc
    ...
    *,
    ...
    if article_factory is None:
        try:
            ...
            raise ImportError(
                "newspaper3k_extractor_factory requires the optional 'newspaper3k' package "
    ...
    *,
    ...
    if document_factory is None:
        try:
            ...
            raise ImportError(
                "readability_extractor_factory requires the optional 'readability-lxml' package "
