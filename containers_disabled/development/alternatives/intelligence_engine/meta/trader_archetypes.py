...
class TraderArchetype:
    ...
    group: str = ""
    philosophy: str = ""
    belief_system: Mapping[str, float] = dataclasses.field(default_factory=dict)
    ...
    regime_performance: Mapping[str, float] = dataclasses.field(default_factory=dict)
...
def _coerce_archetype(archetype_id: str, body: Mapping[str, Any]) -> TraderArchetype:
    ...
    return TraderArchetype(
        ...
        philosophy=str(body.get("philosophy", "")),
