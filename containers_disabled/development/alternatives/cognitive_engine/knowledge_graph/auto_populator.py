...
class KnowledgeGraphAutoPopulator:
    ...
    def update_from_trade(self, trade_event: dict[str, Any]) -> KnowledgeExtraction:
        ...
        try:
            ...
            logger.debug(f"[KG_AUTO] Populated knowledge from trade: {strategy} {side} {asset}")
            ...
            return KnowledgeExtraction(
                source_type="trade", entities=[], relationships=[], confidence=0.0
            )
    ...
    def update_from_market(self, market_data: dict[str, Any]) -> KnowledgeExtraction:
        ...
        try:
            ...
            return KnowledgeExtraction(
                source_type="market", entities=[], relationships=[], confidence=0.0
            )
    ...
    def update_from_narrative(self, narrative_data: dict[str, Any]) -> KnowledgeExtraction:
        ...
        try:
            ...
            return KnowledgeExtraction(
                source_type="narrative", entities=[], relationships=[], confidence=0.0
            )
    ...
    def _get_or_create_strategy_node(self, strategy: str, context: dict[str, Any]) -> KnowledgeNode:
        ...
        return self._kg.add_node(
            NodeType.STRATEGY, strategy, created_at=now().utc_time.isoformat(), **context
        )
    ...
    def _get_or_create_asset_node(self, asset: str, context: dict[str, Any]) -> KnowledgeNode:
        ...
        return self._kg.add_node(
            NodeType.ASSET, asset, created_at=now().utc_time.isoformat(), **context
        )
    ...
    def _get_or_create_regime_node(self, regime: str, context: dict[str, Any]) -> KnowledgeNode:
        ...
        return self._kg.add_node(
            NodeType.CONDITION, regime, created_at=now().utc_time.isoformat(), **context
        )

    def _get_or_create_narrative_node(
        ...
        return self._kg.add_node(
            NodeType.NARRATIVE, narrative, created_at=now().utc_time.isoformat(), **context
        )
