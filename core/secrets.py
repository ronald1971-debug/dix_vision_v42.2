...
def get_secret(name: str, default: str | None = None) -> str:
    ...
    try:
        ...
        sys.stderr.write(f"[core.secrets.get_secret] keyring failed: {exc}\n")
    v = _mgr().get(name, "")
    if v:
        return v
...
def store_secret(name: str, value: str) -> None:
    ...
    try:
        ...
        sys.stderr.write(f"[core.secrets.store_secret] keyring failed: {exc}\n")
...
def delete_secret(name: str) -> None:
    ...
    try:
        ...
        sys.stderr.write(f"[core.secrets.delete_secret] keyring failed: {exc}\n")
